<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageUser.Master" AutoEventWireup="true" CodeBehind="DANHSACHSANPHAM.aspx.cs" Inherits="QUANLYBANHANG_ONLINE.DANHSACHSANPHAM" %>
                        ...
                        <ItemTemplate>
                            <div class="prod_box">
                                ...
                                <div class="center_prod_box">
                                    ...
                                    <div class="product_img"><a href='chitietsanpham.aspx?MASANPHAM=<%# Eval("MASANPHAM") %>'>
                                            <img src="images/<%# Eval("HINHANH") %>" alt="" border="0"width="100px" height="100px" /></a>
                                    </div>
